...
const CharacterPage = () => {
  ...
  const { id } = useParams();
  const singleCharacterData = useSelector(
    (state) => state.singleCharacteReducer.singleCharacterData
  );
  const characterOrigin = useSelector(
    (state) => state.singleCharacteReducer.characterOrigin
  );
